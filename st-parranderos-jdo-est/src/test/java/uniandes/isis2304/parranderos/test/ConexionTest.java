...
public class ConexionTest
{
	 ...
	 */
	private static final String CONFIG_TABLAS_INEXISTENTES = "./src/main/resources/config/TablasBD_INEXISTENTES.json"; 
...
//			e.printStackTrace();
    ...
    public void tablaInexistenteTest ()
    {
		...
		try
		{
			...
			hotelAndes = new HotelAndes (openConfig (CONFIG_TABLAS_INEXISTENTES));
		}
		catch (Exception e)
		{
//			e.printStackTrace();
